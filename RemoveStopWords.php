...
class RemoveStopWords  {
	...
	private function is_stop_word( $word )
	{
		...
		$pattern = '/\b' . $word . '\b/i';
		return preg_match( $pattern, $this->stop_words );   	
